...
lower = {'red':(155,50,0), 'blue':(100, 50, 75), 'orange':(10,50,60)}
upper = {'red':(185,225,160), 'blue':(230,150,120), 'orange':(60,100,120)}
colors = {'blue':(255,0,0), 'red':(0,0,255), 'orange':(0,165,255)}
###############################################################################################
...
if __name__ == '__main__':
    try:
        camUrl='rtsp://192.168.1.105:5540/ch0'
            ...
            if rval:
                ...
                for key, value in upper.items():
                    ...
                    # centroid
						...
						#	b = 3102
						#	c = -0.5331
                        #	dist = 239.6 + 3102/(y - 0.5331)
                            print(str(key)+"\t"+"("+str(x)+","+str(y)+")"+"\t\t"+"distance"+"\t"+str(239.6 + 3102/(y - 0.5331)))
                            ''' 
